...
static void handle_logon	PROTO((int client_sock, CLIENT_PACKET *request));
static void handle_ping		PROTO((int client_sock, CLIENT_PACKET *request));
static void handle_restart	PROTO((int client_sock, CLIENT_PACKET *request));
static void handle_kill		PROTO((int client_sock, CLIENT_PACKET *request));
static void handle_dump		PROTO((int client_sock, CLIENT_PACKET *request));
static int send_response	PROTO((int client_sock, CLIENT_PACKET *response));
