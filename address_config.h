...
struct address_config {
  ...
  int			default_type;	/* What type of default logical
					   addresses			*/
  int			mode_bits;	/* What mode bits to use for
					   logical addressing		*/
...
struct address_config	addr_config =
	{ NETADDR_NULL, 0x000, DO_LA_1374, LOGICAL_SELECT | CAMPON,
	    NULL, 0xf00 };
